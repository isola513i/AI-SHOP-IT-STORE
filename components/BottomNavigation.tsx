...
import { Home, Store, Scale, Heart, User, Bot } from 'lucide-react';
...
export const BottomNavigation: React.FC<BottomNavigationProps> = ({ 
  ...
  return (
    <>
      ...
      {activeTab === 'home' && (
        <button className="fixed bottom-28 right-5 z-40 bg-white text-blue-600 w-14 h-14 rounded-2xl shadow-xl shadow-blue-500/20 flex items-center justify-center transition-all duration-500 animate-in slide-in-from-bottom-4 zoom-in hover:scale-110 active:scale-90 group max-w-md left-1/2 ml-[calc(50%-28px+140px)]">
          <Bot size={28} fill="currentColor" className="group-hover:rotate-12 transition-transform" />
